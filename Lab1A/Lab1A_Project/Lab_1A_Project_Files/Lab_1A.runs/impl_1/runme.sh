...
HD_PWD='/fs/student/mgdaily/Documents/ECE153/Lab1A/Lab1A_Project/Lab_1A_Project_Files/Lab_1A.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log lab1_template_wrapper.vdi -applog -m64 -messageDb vivado.pb -mode batch -source lab1_template_wrapper.tcl -notrace
